...
android {
    ...
    defaultConfig {
        ...
        // Load local.properties manually since Gradle doesn't do it for project properties
        ...
        val supabaseAnonKey = localProperties.getProperty("SUPABASE_ANON_KEY") ?: System.getenv("SUPABASE_ANON_KEY") ?: ""
